...
const Sign_Up = () => {
    ...
    useTitle('Sign Up | Join us | ResuMeUp')
        ...
        <>
            <div className="flex flex-row">
                ...
                <form className="flex flex-col justify-center m-auto h-screen" onSubmit={handleSubmit}>
                    ...
                    <h1 className="text-4xl mb-6 font-bold text-foreground"> Sign Up </h1>
                    ...
                    <p className="text-center text-foreground underline cursor-pointer" onClick={() => {to('/sign-in')}}> Sign In </p>
                    <span className="fa fa-arrow-left text-foreground cursor-pointer" onClick={() => {to('/')}}> Back </span>
