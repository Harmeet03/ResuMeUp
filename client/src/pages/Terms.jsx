    ...
    return(
        <>
            <div className="py-10 px-4 lg:w-250 sm:m-auto">
                ...
                <h1 className="sm:text-6xl font-bold mb-4 text-3xl text-blue"> 📄 Terms & Conditions </h1>
                <p className="text-xl mb-4"> Last updated: June 12, 2025 </p>
                <p className="text-sm mb-4 text-foreground"> Welcome to ResuMeUp. <br/> By accessing or using our website, you agree to be bound by the following Terms and Conditions. </p>
                <div className="text-xl">
                    <h1 className="font-bold text-foreground"> 1. Use of the Website </h1>
                    <p className="mb-8 text-[16px]"> You must be at least 13 years old to use this service.<br/> You agree not to misuse the platform or attempt to access unauthorized data. </p>
                    
                    <h1 className="font-bold text-foreground"> 2. Account Registration </h1>
                    ...
                    <h1 className="font-bold text-foreground"> 3. User Data & Privacy </h1>
                    <p className="mb-8 text-[16px]">
                    ...
                    <h1 className="font-bold text-foreground"> 4. Intellectual Property </h1>
                    <p className="mb-8 text-[16px]">  
                    ...
                    <h1 className="font-bold text-foreground"> 5. Limitation of Liability </h1>
                    <p className="mb-8 text-[16px]">
                    ...
                    <h1 className="font-bold text-foreground"> 6. Changes to These Terms </h1>
                    <p className="mb-8 text-[16px]">
